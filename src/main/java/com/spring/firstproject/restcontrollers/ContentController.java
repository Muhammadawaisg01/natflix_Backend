...
import com.spring.firstproject.services.ContentTypeService;
...
public class ContentController {
	...
	public String add(@RequestBody Content content) {
		...
		content_Type=contentTypeService.getbyType(content.getType().getType());
	...
	public ResponseEntity<?> update(@RequestBody Content content, @PathVariable Integer id) {
	    try {
	        ...
	        Content_Type content_Type=contentTypeService.getbyType(content.getType().getType());
